...
export default function SimulationPanel({
  ...
  return (
    <div className="absolute bottom-2 left-1/2 -translate-x-1/2 z-[1000] w-[95vw] sm:w-[600px] max-w-[calc(100vw-2rem)]">
      <div className="bg-dark-700/95 backdrop-blur-md rounded-2xl border border-dark-400/50 shadow-2xl p-3 sm:p-4">
        {/* Header */}
        ...
        <div className="flex items-center justify-center gap-1.5 sm:gap-2 flex-wrap">
          <button
            ...
            className="flex items-center gap-1 px-2 sm:px-3 py-1.5 bg-fire-600 hover:bg-fire-500 disabled:bg-dark-500 disabled:text-gray-600 text-white text-[10px] sm:text-xs rounded-lg transition"
          >
          ...
          <button
            onClick={() => onStep(6)}
            disabled={loading || currentHour >= 24}
            className="flex items-center gap-1 px-2 sm:px-3 py-1.5 bg-fire-700 hover:bg-fire-600 disabled:bg-dark-500 disabled:text-gray-600 text-white text-[10px] sm:text-xs rounded-lg transition"
          >
            +6h
          </button>
          ...
          <button
            ...
            className={`flex items-center gap-1 px-2 sm:px-3 py-1.5 text-[10px] sm:text-xs rounded-lg transition ${
              autoPlay
          ...
          <button
            onClick={onExplain}
            disabled={loading}
            className="flex items-center gap-1 px-2 sm:px-3 py-1.5 bg-purple-600/20 hover:bg-purple-600/30 text-purple-400 text-[10px] sm:text-xs rounded-lg border border-purple-500/30 transition"
          >
          ...
          <button
            onClick={onReset}
            className="flex items-center gap-1 px-2 sm:px-3 py-1.5 bg-dark-500 hover:bg-dark-400 text-gray-400 text-[10px] sm:text-xs rounded-lg transition"
          >
